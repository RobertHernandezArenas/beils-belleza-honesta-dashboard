			...
			<form @submit.prevent="onSubmit" class="space-y-5 p-6">
				...
				<div class="form-control">
					...
					<textarea
						...
						class="textarea bg-bg-muted hover:bg-bg-card focus:bg-bg-card focus:border-border-subtle focus:ring-border-subtle/30 text-text-primary placeholder:text-text-muted/50 h-24 w-full resize-none rounded-xl border-transparent font-medium shadow-inner transition-all focus:ring-4"
				...
				<div class="form-control">
					...
					<div class="relative flex items-center">
						<input
							...
							class="input bg-bg-muted hover:bg-bg-card focus:bg-bg-card focus:border-border-subtle focus:ring-border-subtle/30 text-text-primary placeholder:text-text-muted/50 h-12 w-full rounded-xl border-transparent pr-16 font-medium shadow-inner transition-all focus:ring-4"
