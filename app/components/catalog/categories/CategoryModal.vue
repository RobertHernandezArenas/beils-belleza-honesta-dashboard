				...
				<div class="form-control">
					...
					<div class="relative flex items-center">
						<input
							...
							class="input bg-bg-muted hover:bg-bg-card focus:bg-bg-card focus:border-border-subtle focus:ring-border-subtle/30 text-text-primary placeholder:text-text-muted/50 h-12 w-full rounded-xl border-transparent pr-16 font-medium shadow-inner transition-colors transition-transform focus:ring-4"
