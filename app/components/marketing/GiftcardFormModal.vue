					...
					<div class="form-control">
						...
						<div class="relative">
							<input
								...
								type="text"
								required
								class="input bg-bg-muted border-border-default focus:bg-bg-card focus:ring-border-subtle/40 hover:bg-bg-hover h-12 w-full rounded-xl pr-12 text-center font-mono text-xl font-black tracking-[0.2em] shadow-sm transition-all focus:shadow-md focus:outline-none" />
							<button
								type="button"
								v-if="!editingCard"
								@click="generateCode"
					...
					<div class="grid grid-cols-2 gap-5">
						<div class="form-control">
							...
							<input
								...
								class="input bg-bg-muted border-border-default focus:bg-bg-card focus:ring-border-subtle/40 hover:bg-bg-hover h-11 w-full rounded-xl px-4 text-sm font-bold tabular-nums shadow-sm transition-all focus:shadow-md focus:outline-none disabled:opacity-50" />
						</div>
						...
						<div class="form-control" v-if="editingCard">
							...
							<input
								...
								min="0"
								required
								class="input bg-primary/10 border-primary text-primary focus:bg-bg-card focus:ring-primary h-11 w-full rounded-xl px-4 text-sm font-bold tabular-nums shadow-sm transition-all focus:shadow-md focus:outline-none" />
						</div>
					</div>
