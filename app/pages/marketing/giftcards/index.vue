		...
		<div class="mx-auto max-w-7xl">
			...
			<div
				...
				<div
					...
					class="group bg-bg-card border-border-default hover:border-border-strong relative flex flex-col justify-between overflow-hidden rounded-3xl border p-6 shadow-sm transition-all duration-300 hover:shadow-md">
					<!-- Background Pattern -->
