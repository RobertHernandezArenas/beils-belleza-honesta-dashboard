	...
	<div class="bg-bg-app min-h-screen w-full p-4 font-sans lg:p-10">
		<div class="mx-auto max-w-[1200px]">
			<div class="mb-8 flex items-center gap-4">
				<NuxtLink
					to="/clientes"
					class="btn btn-circle btn-ghost bg-bg-card hover:bg-bg-muted border-border-subtle hover:border-text-secondary border shadow-sm transition-all">
			...
			<div v-else-if="client" class="space-y-6">
				...
				<div class="bg-bg-card border-border-subtle overflow-hidden rounded-3xl border shadow-sm">
					<div class="border-border-subtle bg-bg-muted/30 flex overflow-x-auto border-b">
						<button
							class="flex items-center gap-2 border-b-2 px-6 py-4 text-sm font-bold whitespace-nowrap transition-all"
							:class="
								currentTab === 'info'
