		...
		<div class="mx-auto flex h-full w-full max-w-[1400px] flex-col lg:overflow-hidden gap-6">
			...
			<div class="flex flex-col md:flex-row justify-between items-center gap-4 mt-2">
				...
				<div class="bg-bg-card border border-border-default/80 rounded-xl p-1 flex items-center shadow-[0_2px_8px_rgba(0,0,0,0.04)] gap-0.5">
					<button :class="summaryTimeframe === 'day' ? 'bg-bg-muted/80 text-text-primary shadow-sm ring-1 ring-border-default/50' : 'text-text-muted hover:text-text-primary hover:bg-bg-muted/30'" class="px-3.5 py-1 rounded-lg text-[10px] font-extrabold tracking-wide uppercase transition-all duration-200" @click="summaryTimeframe = 'day'">Día</button>
					<button :class="summaryTimeframe === 'week' ? 'bg-bg-muted/80 text-text-primary shadow-sm ring-1 ring-border-default/50' : 'text-text-muted hover:text-text-primary hover:bg-bg-muted/30'" class="px-3.5 py-1 rounded-lg text-[10px] font-extrabold tracking-wide uppercase transition-all duration-200" @click="summaryTimeframe = 'week'">Semana</button>
					<button :class="summaryTimeframe === 'month' ? 'bg-bg-muted/80 text-text-primary shadow-sm ring-1 ring-border-default/50' : 'text-text-muted hover:text-text-primary hover:bg-bg-muted/30'" class="px-3.5 py-1 rounded-lg text-[10px] font-extrabold tracking-wide uppercase transition-all duration-200" @click="summaryTimeframe = 'month'">Mes</button>
					<button :class="summaryTimeframe === 'year' ? 'bg-bg-muted/80 text-text-primary shadow-sm ring-1 ring-border-default/50' : 'text-text-muted hover:text-text-primary hover:bg-bg-muted/30'" class="px-3.5 py-1 rounded-lg text-[10px] font-extrabold tracking-wide uppercase transition-all duration-200" @click="summaryTimeframe = 'year'">Año</button>
				</div>
			</div>
