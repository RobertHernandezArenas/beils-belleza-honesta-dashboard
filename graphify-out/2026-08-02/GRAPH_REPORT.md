...
## Corpus Check
- 585 files · ~580,849 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4638 nodes · 5057 edges · 563 communities (478 shown, 85 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2fa0ec02`
...
- `main()` --references--> `@prisma/client`  [EXTRACTED]
  scripts/merge-client.ts → package.json
- `main()` --references--> `@prisma/client`  [EXTRACTED]
...
## Communities (563 total, 85 thin omitted)
...
### Community 107 - "dexie"
Cohesion: 0.10
Nodes (21): aos, dexie, echarts, lucide-vue-next, @nuxt/fonts, dependencies, aos, dexie (+13 more)
...
### Community 117 - "@nuxt/fonts"
Cohesion: 0.47
Nodes (5): arg(), CONFIRM, main(), prisma, resolveClient()
...
Cohesion: 0.07
Nodes (41): ApiResponse, batchCreateElementsOnCanvas(), SyncResponse, convertTextToLabel(), ElementInput, normalizePoints(), prepareElement(), prepareElementUpdate() (+33 more)
...
Cohesion: 0.18
Nodes (22): start(), status(), stop(), foreignServiceError(), getHealth(), markCanvasIdentityVerified(), pidFilePath(), readPidFile() (+14 more)

### Community 141 - "vite"
Cohesion: 0.17
Nodes (16): CliUsageError, FlagSpec, ParsedArgs, countFiles(), expandHome(), findSkillSource(), installSkill(), resolveSkillsRoot() (+8 more)

### Community 142 - "@vite-pwa/nuxt"
Cohesion: 0.05
Nodes (61): app, canConnect(), clients, computeEdgePoint(), CreateElementSchema, __dirname, __filename, findExistingLoopbackListener() (+53 more)
...
Cohesion: 0.20
Nodes (30): parseArgs(), readStdin(), add(), apply(), coerce(), del(), get(), lookupPath() (+22 more)
...
Cohesion: 0.20
Nodes (18): snapshot(), assertCanvasIdentity(), batchCreateElementsStrict(), clearCanvas(), createElementOnCanvas(), deleteElementOnCanvas(), exportImage(), getFiles() (+10 more)
...
Cohesion: 0.13
Nodes (15): heightClass, model, onReflow(), open, openPanel(), Option, panelRef, panelStyle (+7 more)
...
## Knowledge Gaps
- **2772 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+2767 more)
...
- **Why does `dependencies` connect `dexie` to `vue`, `vue-echarts`, `@vueuse/core`, `workbox-window`, `@xmldom/xmldom`, `zod`, `Async Component Best Practices`, `html2pdf.js`, `dependencies`, `aos`, `types.ts`, `@peculiar/webcrypto`, `prisma`, `@prisma/adapter-mariadb`, `package.json`, `dotenv`, `nuxt`, `bcryptjs`, `gsap`, `mariadb`, `@nuxt/eslint`, `@nuxt/image`, `pinia`, `@pinia/nuxt`, `qrcode.vue`, `soap`, `@tanstack/vue-query`?**
