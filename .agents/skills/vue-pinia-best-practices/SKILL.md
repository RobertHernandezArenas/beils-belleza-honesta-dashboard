...
description:
   'Trigger: pinia, store pinia, defineStore, storeToRefs, state management vue, persistencia pinia. Pinia
   stores, state management patterns, store setup, and reactivity with stores.'
version: 1.0.0
license: MIT
metadata:
   author: vuejs-ai
